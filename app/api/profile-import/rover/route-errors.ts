...
const STATUS: Partial<Record<RoverImportErrorCode, number>> = {
  ...
  RATE_LIMITED: 429, ATTEMPT_ACTIVE: 409, ATTEMPT_ALREADY_USED: 409, PROFILE_CHANGED: 409,
...
const COPY: Record<RoverImportErrorCode, string> = {
  ...
  RATE_LIMITED: 'You have reached the import limit. Try again later.', ATTEMPT_ACTIVE: 'An import is already running for this site.',
