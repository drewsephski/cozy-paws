...
export function ProfileRichFields({ site }: { site: BusinessProfile }) {
  const services = site.services ?? [];
  return <div className="contents">
    <div className="sm:col-span-2 mt-2 border-t border-border pt-5"><h3 className="font-semibold">Your care in more detail</h3><p className="mt-1 text-xs leading-5 text-muted-foreground">Optional details help pet owners understand whether your care fits their routine.</p></div>
