Utilize the skills in this repository whenever working on the codebase.
For browser QA, use the available Dia integration if exposed, and keep local verification, CI, deployment, and real production behavior as separate gates.
